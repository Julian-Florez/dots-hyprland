            ...
            property JsonObject background: JsonObject {
                property JsonObject widgets: JsonObject {
                    property JsonObject clock: JsonObject {
                        ...
                        property real x: 100
                        property real y: 100
                        property bool forceCenter: true
                        ...
                        property JsonObject cookie: JsonObject {
                            ...
                            property real size: 230
                            property bool customColors: false
                            property string colBackground: "#e66420"
                            property string colOnBackground: "#ffffff"
                            property string colBackgroundInfo: "#ffffff"
                            property string colHourHand: "#ff9980"
                            property string colMinuteHand: "#a2d929"
                            property string colSecondHand: "#ffffff"
                        }
