...
Item {
    ...
    FadeLoader {
        ...
        sourceComponent: Dots {
            color: root.color
            margins: (46 - dotsLoader.opacity * 34) * root.scaleFactor
        }
    }
    ...
    FadeLoader {
        ...
        sourceComponent: BigHourNumbers {
            numberSize: 80 * root.scaleFactor
            color: root.color
            margins: (20 - 10 * bigHourNumbersLoader.opacity) * root.scaleFactor
        }
    }
    ...
    FadeLoader {
        ...
        sourceComponent: Lines {
            color: root.color
            margins: (46 - linesLoader.opacity * 34) * root.scaleFactor
        }
    }
