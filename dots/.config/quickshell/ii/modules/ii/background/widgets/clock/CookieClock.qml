...
Item {
    ...
    property real implicitSize: Config.options.background.widgets.clock.cookie.size || 230
    readonly property real scaleFactor: implicitSize / 230

    property color colShadow: Appearance.colors.colShadow
    property color colBackground: Config.options.background.widgets.clock.cookie.customColors ? Config.options.background.widgets.clock.cookie.colBackground : Appearance.colors.colPrimaryContainer
    property color colOnBackground: Config.options.background.widgets.clock.cookie.customColors ? Config.options.background.widgets.clock.cookie.colOnBackground : ColorUtils.mix(Appearance.colors.colSecondary, Appearance.colors.colPrimaryContainer, 0.15)
    property color colBackgroundInfo: Config.options.background.widgets.clock.cookie.customColors ? Config.options.background.widgets.clock.cookie.colBackgroundInfo : ColorUtils.mix(Appearance.colors.colPrimary, Appearance.colors.colPrimaryContainer, 0.55)
    property color colHourHand: Config.options.background.widgets.clock.cookie.customColors ? Config.options.background.widgets.clock.cookie.colHourHand : Appearance.colors.colPrimary
    property color colMinuteHand: Config.options.background.widgets.clock.cookie.customColors ? Config.options.background.widgets.clock.cookie.colMinuteHand : Appearance.colors.colTertiary
    property color colSecondHand: Config.options.background.widgets.clock.cookie.customColors ? Config.options.background.widgets.clock.cookie.colSecondHand : Appearance.colors.colPrimary
