...
// Hyprland reports this exact keymap name for `kb_layout = latam`.
// Start from the physical US keycodes and replace the legends for Latin America.
const latinAmericanLegends = {
    2: { label: "1", labelShift: "!" }, 3: { label: "2", labelShift: '"' },
    4: { label: "3", labelShift: "#" }, 5: { label: "4", labelShift: "$" },
    6: { label: "5", labelShift: "%" }, 7: { label: "6", labelShift: "&" },
    8: { label: "7", labelShift: "/" }, 9: { label: "8", labelShift: "(" },
    10: { label: "9", labelShift: ")" }, 11: { label: "0", labelShift: "=" },
    12: { label: "'", labelShift: "?" }, 13: { label: "¿", labelShift: "¡" },
    26: { label: "´", labelShift: "¨" }, 27: { label: "+", labelShift: "*" },
    39: { label: "ñ", labelShift: "Ñ" }, 40: { label: "{", labelShift: "[" },
    43: { label: "}", labelShift: "]" }, 51: { label: ",", labelShift: ";" },
    52: { label: ".", labelShift: ":" }, 53: { label: "-", labelShift: "_" }
};

byName["Spanish (Latin American)"] = {
    name_short: "ES",
    description: "Español latinoamericano - Completo",
    comment: "Spanish Latin American keyboard layout",
    keys: byName["English (US)"].keys.map(row =>
        row.map(key => Object.assign({}, key, latinAmericanLegends[key.keycode] || {}))
    )
};
