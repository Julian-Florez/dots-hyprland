...
apply_term() {
  apply_anyterm &
  apply_kitty &
  "$SCRIPT_DIR/apply_vscode.py" &
  "$SCRIPT_DIR/apply_android_studio.py" &
  "$SCRIPT_DIR/apply_chrome.py" &
  "$SCRIPT_DIR/apply_saber.py" &
  "$SCRIPT_DIR/apply_inkscape.py" &
  "$SCRIPT_DIR/apply_vesktop.py" &
}
