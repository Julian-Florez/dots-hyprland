...
Item {
    ...
    property real hourLineSize: 4 * scaleFactor
    property real minuteLineSize: 2 * scaleFactor
    property real hourLineLength: 18 * scaleFactor
    property real minuteLineLength: 7 * scaleFactor
